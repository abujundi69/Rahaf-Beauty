...
export default function PromoBanner() {
  ...
  return (
    <section className="container-page py-10">
      <div className="overflow-hidden rounded-[1.5rem] bg-gradient-to-r from-charcoal via-terracotta to-clay text-white shadow-soft">
        <div className="grid gap-8 p-8 md:grid-cols-[1.1fr_0.9fr] md:p-10">
          ...
          <div className="grid grid-cols-3 items-end gap-4">
            ...
            <div className="h-56 rounded-2xl bg-gradient-to-b from-shell to-rose shadow-card" />
